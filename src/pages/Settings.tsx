      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-200">Manage your Regal Meet preferences</p>
            </div>
          </div>
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="bg-red-500/20 border-red-400/40 text-white hover:bg-red-500/30"
          >
            Sign Out
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-white/10 backdrop-blur-xl border-white/20">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-white/90">Auto-join with video</label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-white/90">Auto-join with audio</label>
                <Switch
              ...
              <div>
                <label className="text-sm font-medium text-white/90">Video Quality</label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-black/90 border-white/20">
                    <SelectItem value="low" className="text-white hover:bg-white/10">Low (Better for slow connections)</SelectItem>
                    <SelectItem value="medium" className="text-white hover:bg-white/10">Medium (Balanced)</SelectItem>
                    <SelectItem value="high" className="text-white hover:bg-white/10">High (Best quality)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </CardContent>
          ...
          <Card className="bg-white/10 backdrop-blur-xl border-white/20">
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="text-sm font-medium text-white/90">Default Microphone</label>
                <Select
              ...
              <div>
                <label className="text-sm font-medium text-white/90">Default Camera</label>
                <Select

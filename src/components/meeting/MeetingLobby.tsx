...
export const MeetingLobby = ({ meetingId, userId, userName, onAdmit, onCancel }: MeetingLobbyProps) => {
  ...
  }, [meetingId, userId, userName, onAdmit, onCancel]);
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#0a0612]">
      ...
      <div className="relative hidden lg:flex flex-1 items-end overflow-hidden">
        <img src={lobbyImage} alt="Waiting for host" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent" />
        <div className="relative z-10 p-10 xl:p-16">
          ...
          <h2 className="text-3xl xl:text-4xl font-bold text-white max-w-md leading-tight">

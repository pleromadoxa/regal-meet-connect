  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-target",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-card text-card-foreground hover:bg-accent hover:text-accent-foreground shadow-md hover:shadow-lg hover:scale-105",
        secondary:
        ...
        premium: "gradient-primary text-white shadow-glow hover:shadow-xl hover:scale-105 font-semibold",
        hero: "gradient-secondary text-white shadow-lg hover:shadow-xl hover:scale-105 font-semibold",
        glass: "glass-morphism text-foreground hover:glass-morphism-elevated hover:scale-105",
      },
      size: {

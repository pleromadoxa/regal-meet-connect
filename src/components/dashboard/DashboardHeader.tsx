  ...
  return (
    <div className="flex flex-col gap-4 mb-6 md:mb-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
        ...
        <div className="flex flex-wrap items-center justify-start gap-2 md:gap-3 lg:gap-4">
          ...
          <Button
            ...
            variant="secondary"
            size={isMobile ? "sm" : "sm"}
            className="bg-white/10 border-white/15 text-white hover:bg-white/15 hover:border-white/25 backdrop-blur-sm flex-shrink-0"
          >
      ...
      <div className="flex justify-center md:justify-start">
        <RegalProductNav active="meeting" size="sm" />
      </div>
    </div>
  );
};
